const NewHome = () => {
  return (
    <div className="w-[100vw] h-[100vh] bg-img-header bg-cover bg-center flex items-center justify-end relative">
      <div className="bg-peach w-643 h-443 z-10 mr-58 flex justify-center items-center">
        <div className="w-546">
